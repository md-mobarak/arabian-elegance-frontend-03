...
//                       className="mr-4 text-red-500 opacity-0 group-hover:opacity-100 transition-opacity"
//                     >
//                       ✕
//                     </button>
//                     <div>
...
//                 <button className="w-full bg-orange-600 text-white py-3 rounded-xl hover:bg-orange-700 transition transform hover:scale-[1.01]">
//                   Proceed to Checkout
//                 </button>
                
//                 <button className="w-full border-2 border-orange-600 text-orange-600 py-3 rounded-xl hover:bg-orange-50 transition">
//                   Continue Shopping
//                 </button>
//               </div>
